        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-lg-6">
            <div class="help-form text-center">
              <h2 class="display-6 fw-bold mb-4" data-aos="fade-up" data-aos-duration="800">Privacy Policy </h2>
              <!-- Form -->
              
            </div>
          </div>
        </div>
        <!-- <h5 class="my-5 text-center">Or Browse Catagories</h5> -->
      </div>
      <div class="container">
        <div class="row g-5">
          <div class="col-12 col-lg-12" data-aos="flip-left" data-aos-duration="800">                       
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minima ipsum porro facere praesentium dolorum nesciunt ratione error omnis, corrupti saepe aspernatur. Cum quia corrupti quasi, fuga ipsa iste ab possimus.
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur quibusdam, nisi blanditiis dolore suscipit molestiae dicta. Rem unde deserunt ratione iste, ex, perferendis odio voluptates aliquam, tempore debitis quos sed.
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo cum, quam, odit distinctio nesciunt aliquid mollitia soluta consectetur assumenda fugiat non doloribus? Perspiciatis harum, excepturi sequi facilis beatae nostrum vitae.</p>
