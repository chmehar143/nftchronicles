        ...
        <div class="col-12 col-sm-6 col-lg-4 col-xl-4 aos-init aos-animate"  data-aos="flip-right" data-aos-duration="800">
                ...
                <div class="nft-card card border-0" style="box-shadow:5px 20px 30px black;">
                    <a href="http://127.0.0.1:8000/item-details/35">
                        ...
                        <div class="img-wrap"><img src="https://global-uploads.webflow.com/61a98989a418f6f2acefef70/6216d083dc18aba91a1911a2_Myria%20NFT%20Drops%20Calendar%20GA%20-%20Aubrey%20Paller-p-500.jpeg" style="width:99%" class="img-fluid" alt="">
                        ...
                        <p class="text-center"><a href="#">@DominationArena</a> is giving away<br>3 Domination NFTs</p>
                        ...
                        <span class="d-block fz-15" style="color: white;  text-align-last: center;"><i class="bi bi-check mb-1" style="font-size:19px;color:#DC6A2A;"></i><span style="font-size:15px" class="me-1">Follow
                         <a href="#">@DominationArena</a><span></span></span></span>
                         <span class="d-block fz-15" style="color: white;  text-align-last: center;"><i class="bi bi-check mb-1" style="font-size:19px;color:#DC6A2A;"></i><span style="font-size:15px" class="me-1">Follow
                         <a href="#">@DominationArena</a><span></span></span></span>
                         <span class="d-block fz-15" style="color: white;  text-align-last: center;"><i class="bi bi-check mb-1" style="font-size:19px;color:#DC6A2A;"></i><span style="font-size:15px" class="me-1"> Like & RT
                         <a href="#">@nftchronicles</a><span></span></span></span>
                         ...
                         <a href="#">@Discord</a><span></span></span></span><br>
