      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-12 col-lg-8">
            <h4 class="mb-4">All Questions</h4>
            @foreach($faqs as $faq)
            <div class="card shadow-sm mt-3">
              <div class="card-body px-4"><a class="d-block fz-18 hover-primary" href="{{route('question-details',$faq->id)}}" style="color: white;">{{$faq->question}}</a></div>
            </div>
              @endforeach
          </div>
