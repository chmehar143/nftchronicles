                                    ...
                                    <form method="post" action="{{route('admin.newssave')}}" enctype="multipart/form-data" class="form">
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<textarea name="description" id="description" class="form-control form-control-lg form-control-solid @error('description') is-invalid @enderror" placeholder="News Description "  rows="6"></textarea>
                                                    @error('description')
                                                    <div class="validation mt-1">{{ $message }}</div>
                                                    @enderror
												</div>
