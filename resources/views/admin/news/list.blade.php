								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<!--begin::Add customer-->
											<a type="button" class="btn btn-primary" href="{{ url('admin/newscreate') }}" >Add Blog</a>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table"  >
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" >
												...
												<th class="min-w-125px">Blog Heading  </th>
												<th class="min-w-125px">Blog Description </th>
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<td><a href="#" class="text-gray-600 text-hover-primary mb-1">Description </a></td>
												<td> Category  </td>
												<td class="text-end">
													...
													<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
														...
														<div class="menu-item px-3">
															<a href="{{ url('admin/newsview') }}" class="menu-link px-3">View</a>
														</div>
														<!--end::Menu item-->

														<div class="menu-item px-3">
															<a href="{{ url('admin/newsedit') }}" class="menu-link px-3">Edit</a>
														</div>
