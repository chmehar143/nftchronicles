								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<!--begin::Add customer-->
											<a type="button" class="btn btn-primary" href="apps/customers/addnft.html" >Add Nft</a>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table"  >
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" >
												...
												<th class="min-w-125px">NFT Description </th>
											...
											<tr>
												...
												<td>
													<div class="form-check form-check-sm form-check-custom form-check-solid">
														<input class="form-check-input" type="checkbox" value="1" /></td>
											
												<td><img src="#" class="text-gray-800 text-hover-primary mb-1"></td>
												<td>Sean Bean</td>
												<td><a href="#" class="text-gray-600 text-hover-primary mb-1">sean@dellito.com</a></td>
												<td>Astro Limited</td>
												<td>SeanSeanSean</td>	
												<td><input type="button" class="btn btn-primary btn-sm" id="approve" value="Approve" onclick="approveData()"/></td>

												<td><input type="button" class="btn btn-danger btn-sm" id="reject" value="Reject" onclick="rejectData()"/></td>										
												<td class="text-end">
