                ...
                <table class="table table-flush fw-bold gy-1">
                    <div class="container">
                       ...
                       <tr style="line-height:6pc">
                            ...
                            <td class="text-gray-800">{{$faq->question}}</td>
                        </tr>
                    </div>
                    ...
                    <div class="col-md-6">
                    <tr style="line-height:6pc">
                            <td class="text-muted min-w-125px w-125px"> Faqs  Answer	</td>
                            <td class="text-gray-800">{{$faq->answer}} </td>
                        </tr>
                    </div>
                    ...
                    <tr style="line-height:6pc">
                            ...
                            <td class="text-gray-800"><img src="{{ asset($faq->file_path) }}"  class="img-fluid" style="width: 150px;"></td>
                        </tr>
                    </div>
