                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="answer" id="answer" class=" @error('answer') is-invalid @enderror form-control form-control-lg form-control-solid" placeholder="Answer"  rows="3"></textarea>
                                @error('answer')
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-bold fs-6" > Faq Category</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
