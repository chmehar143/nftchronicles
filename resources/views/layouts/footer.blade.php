<footer class="footer-area pb-120 pt-120" style="background-color:#272727!important">
<!-- <img class="footer-bg-shape" src="{{asset('img/core-img/shape1.png')}}" alt="" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200"> -->
    <div class="container">
        <div class="row">
            <!-- Footer Widget -->
    ...
    <div class="container">
        <div class="copywrite-wrapper d-lg-flex align-items-lg-center justify-content-lg-between">
            ...
            <div class="copywrite-text text-center text-lg-start mb-3 mb-lg-0">
                <p class="mb-0">2022 &copy; All rights reserved by <a href="#" target="_blank" rel="noreferrer">BS3 Designs</a></p>
            </div>
            <!-- Footer Nav -->
