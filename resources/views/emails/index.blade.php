...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Articles - Nft Chronociles</title>
...
.footer a, .footer a:hover {
	color: #999999;
			...
			<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0"
				marginwidth="0" marginheight="0" width="100%" style="border-collapse:
				...
				<table width="100%" align="center" border="0" cellpadding="0"
					...
					margin: 0; padding: 0; width: 100%;" class="background"><tr><td
							align="center" valign="top" style="border-collapse: collapse;
							...
							<table border="0" cellpadding="0" cellspacing="0" align="center"
								width="560" style="border-collapse: collapse; border-spacing: 0;
							...
							<table border="0" cellpadding="0" cellspacing="0" align="center"
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										...
										Welcome To The <span style="color: #DC6A2A;">Nft Chronociles</span>
									</td>
								</tr>
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										border-spacing: 0; margin: 0; padding: 0;
										padding-top: 20px;" class="hero"><a target="_blank"
											style="text-decoration: none;"
											href="http://nftchronicles.co.uk/"><img border="0" vspace="0"
												hspace="0"
												src="http://nftchronicles.co.uk/storage/uploads/1652883856_download%20(2).jpg"
												alt="Please enable images to view this content" title="Hero Image"
												width="560" style="width: 100%;
												max-width: 560px;
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										...
										padding-bottom: 5px;" class="button"><a
											...
											<table border="0" cellpadding="0" cellspacing="0" align="center"
												style="max-width: 240px; min-width: 120px; border-collapse:
												collapse; border-spacing: 0; padding: 0;"><tr><td align="center"
														valign="middle" style="padding: 12px 24px; margin: 0;
														...
														bgcolor="#E9703E"><a target="_blank" style="text-decoration:
															underline;
															color: #FFFFFF; font-family: sans-serif; font-size: 17px;
															font-weight: 400; line-height: 120%;"
															href="http://nftchronicles.co.uk/">
															Check More Updates
														</a>
													</td></tr></table></a>
									</td>
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%;
										padding-right: 6.25%;" class="list-item"><table align="center"
											border="0" cellspacing="0" cellpadding="0" style="width: inherit;
											...
											<tr>
												...
												<td align="left" valign="top" style="border-collapse: collapse;
													...
													padding-right: 20px;"><img
														border="0" vspace="0" hspace="0" style="padding: 0; margin: 0;
														outline: none; text-decoration: none; -ms-interpolation-mode:
														bicubic; border: none; display: block;
														color: #000000;"
														src="http://nftchronicles.co.uk/storage/uploads/1651172698_1.gif"
												...
												<tr>
													...
													<td align="left" valign="top" style="border-collapse: collapse;
														...
														padding-right: 20px;"><img
															...
															bicubic; border: none; display: block;
															color: #000000;"
															src="http://nftchronicles.co.uk/storage/uploads/1652371973_22.jpg"
													...
													<td align="left" valign="top" style="font-size: 17px; font-weight:
														...
														<b style="color: #333333;">Designer friendly</b><br/>
															Sketch app resource file and a&nbsp;bunch of&nbsp;social media
															icons are&nbsp;also included in&nbsp;GitHub repository.
														</td>
										...
										<tr>
											<td align="center" valign="top" style="border-collapse: collapse;
												...
												color: #000000;
												font-family: sans-serif;" class="paragraph">
												Have a&nbsp;question? <a href="mailto:support@nftchronociles.com"
													target="_blank" style="color: #127DB3; font-family: sans-serif;
										...
										<tr>
											<td align="center" valign="top" style="border-collapse: collapse;
												...
												padding-top: 25px;" class="social-icons"><table
													width="256" border="0" cellpadding="0" cellspacing="0"
													align="center" style="border-collapse: collapse; border-spacing: 0;
													padding: 0;">
													<tr>
	...
	<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%"
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-spacing: 0;
			...
			<td align="center" valign="top" style="border-collapse: collapse;
									...
									color: #000000;
									font-family: sans-serif;" class="subheader">
				<div class="nft-card card mycard mt-5"
					...
					<div class="card-body" style="margin-top:-1px;"><a href="http://127.0.0.1:8000/item-details/34">
							...
							<div class="align-items-center row"
								...
								<div class="col-6"><span class="d-block fz-15"
										style="color: white; margin-left: -4pc;"><img src="img/crypto1.png" width="14%"
...
background: #272727 !important;">
								...
								<div class="row"><a href="http://127.0.0.1:8000/item-details/34">
									...
									<div class="col-4" style="margin-top:13px"><a
										...
										<div style="text-align-last: center;"><a
												href="http://127.0.0.1:8000/item-details/34">
											</a><a href="#"><span class="d-block fz-15" style="color: white;"><img
														src="img/eye.png" class="mb-1"> 0.00k</span></a>
										</div>
									</div>
									<div class="col-4" style="margin-top:16px">
										<div style="text-align-last: center;">

											<a href="#"><span class="d-block fz-15" style="color: white;"><img
														src="img/insta.png" class="mb-1">&nbsp;0.0k</span></a>
										</div>
									</div>
									<div class="col-4" style="margin-top:16px">
										<div style="text-align-last: center;">
											...
											<a href="https://meet.google.com/hxh-mroa-xdn"> <span class="d-block fz-15"
													style="color: white;"><img src="img/twitter.png"
			...
			<tr>
				<td align="center" valign="top" style="border-collapse: collapse;
												...
												color: #000000;
												font-family: sans-serif;" class="paragraph">
					Have a&nbsp;question? <a href="mailto:support@nftchronociles.com" target="_blank" style="color: #127DB3; font-family: sans-serif;
													font-size: 17px; font-weight: 400; line-height: 160%;">support@nftchronicles.com</a>
				</td>
			</tr>
