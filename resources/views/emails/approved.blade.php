				...
				<table width="100%" align="center" border="0" cellpadding="0"
					...
					<tr>
						<td align="center" valign="top"
							style="border-collapse: collapse; border-spacing: 0; margin: 0; padding:
							0;" bgcolor="#F0F0F0">
							...
							<table border="0" cellpadding="0" cellspacing="0" align="center"
								...
								style="border-collapse: collapse; border-spacing: 0; padding: 0; width:
								inherit;
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										...
										<h2 style="color: #DC6A2A;margin-top: 15px;">APPROVED!</h2>
								...
								<tr>
									...
									style=" border-radius: 13px;box-shadow:5px 20px 30px;border:none;">
										...
										<div class="nft-card card"style="width: 75%; border-radius: 13px;">
											...
											<div class="card-body" style="margin-top:2px;margin-left:1px"><a
													href="#">
													<div class="img-wrap">
											...
											<table border="0" cellpadding="0" cellspacing="0" align="center"
												...
												<tr>
													<td align="center" valign="middle"
														style="padding: 12px 24px; margin: 0; text-decoration: underline;
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										...
										Have a&nbsp;question? <a href="mailto:support@nftchronociles.com"
											target="_blank"
											style="color: #127DB3; font-family: sans-serif; font-size: 17px;
											font-weight: 400; line-height: 160%;">support@nftchronicles.com</a>
										<br>
									</td>
								</tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" align="center"
												...
												<td align="center" valign="middle"
													...
													<a target="_blank"
														...
														style="text-decoration: none;"><img border="0" vspace="0"
															...
															none; -ms-interpolation-mode: bicubic; border: none; display:
															inline-block;
												...
												<td align="center" valign="middle"
													...
													<a target="_blank"
														...
														style="text-decoration: none;"><img border="0" vspace="0"
															...
															none; -ms-interpolation-mode: bicubic; border: none; display:
															inline-block;
															color: #000000;" alt="G" title="Google Plus" width="44"
															height="44"
								...
								<tr>
									<td align="center" valign="top" style="border-collapse: collapse;
										border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%;
										padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400;
										line-height: 150%;
										padding-top: 20px;
										padding-bottom: 20px;
										color: #999999;
										...
										your <a href="#"
											target="_blank"
											style="text-decoration: underline; color: #999999; font-family:
											sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">subscription
											settings</a> anytime.
