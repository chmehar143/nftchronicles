...
<head>
	<meta charset="UTF-8">
	<title>Rejected - Email: Nftchronociles</title>
...
<body>
	...
	max-width: 560px;" class="container">
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
								Have a&nbsp;question? <a href="mailto:support@nftchronociles.com" target="_blank"
									style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">support@nftchronicles.com</a>
								<br>
							</td>
						</tr>
	...
	max-width: 560px;" class="wrapper">
			...
			font-family: sans-serif;" class="footer">
								...
								This email was sent by&nbsp;Nft chronociles. You&nbsp;could change your <a href="#"
									target="_blank"
