...
@section('content')
    ...
    <!-- Item Details -->
    <div class="item-details-wrap"style="background-color:#272727; !important"><br><br><br><Br><br>
      <div class="container">
        <div class="row g-4 g-lg-5 justify-content-center" data-aos="flip-left" data-aos-duration="800">
          <div class="col-12 col-md-12 col-lg-6">
            <div class="item-big-thumb"><img src="{{$nft->file_path}}" style="margin-top: 2pc;" alt="" data-action="zoom"></div>
          </div>
          <!-- Item Details Content -->
          <div class="col-12 col-md-9 col-lg-6" data-aos="flip-right" data-aos-duration="800">
  ...
  <!-- <br> -->
          ...
          <div class="row">
            <div class="col-md-6 col-sm-3">
              ...
              <h5 class="text-center mb-0 border border-2 px-3 py-2 border-primary d-inline-block rounded btn-lg"  style="width: 60%;color: white;">{{$nft->blockchain}} </h5>
            </div>
               @if(!empty($nft->marketplace))
            <div class="col-md-6 col-sm-3">
              <p class="mb-2" style="color: white;">Marketplace</p>
              <h5 class="text-center mb-0 border border-2 px-3 py-2 border-primary d-inline-block rounded btn-lg"  style="width: 60%; color: white;">{{$nft->marketplace}}</h5>
            </div>
              @endif
          </div>
          <div class="border-top w-75 my-4"></div>
                ...
                <div class="row">
                  <div class="col-6 col-sm-6">
                    ...
                    <a href="#" style="color: white;"><span class="d-block fz-15   d-inline-block rounded text-primary w-100" style="color: white;"><b>Pre sale Date:</b>&nbsp;
                      <span style="color: #DC6A2A;">{{$nft->pre_sale_date}}</span></span></a>
                 ...
                 <br>
                    <a href="#" style="color: white;"><span class="d-block fz-15   d-inline-block rounded text-primary w-100" style="color: white;"><b>Collection Count:</b>&nbsp;
                      <span style="color: #DC6A2A;">  {{$nft->supply}}&nbsp;</span></span></a>
                      ...
                      <a href="#" style="color: white;"><span class="d-block fz-15   d-inline-block rounded text-primary w-100" style="color: white;"><b>Traits Count:</b>&nbsp;
                        <span style="color: #DC6A2A;">{{$nft->traits_count}}</span></span></a>
                        <br>
                    ...
                    <div class="col-6 col-sm-6">
                      ...
                      <span style="color: #DC6A2A;">{{$nft->pre_sale_price}}</span> </span></a>
                   ...
                   <br>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <h5 class="text-center mb-0 border border-2 px-3 py-2 border-primary d-inline-block rounded btn-lg"  style="width: 60%;color: white;">{{$nft->public_sale_date}} </h5>
                        </div>

                        <div class="col-sm-6">
                          <br>
                          <p class="mb-2" style="color: white;"><i class="bi bi-cash-coin me-1"></i>&nbsp;Public-Sale Price</p>
                          <h5 class="text-center mb-0 border border-2 px-3 py-2 border-primary d-inline-block rounded btn-lg"  style="width: 60%; color: white;"> {{$nft->public_sale_price}} </h5>
                        </div>
          ...
          <div class="col-12">
            <div class="tab--area bg-gray ">
              <ul class="nav nav-tabs" id="funtoTab" role="tablist">
                <li class="nav-item"><a class="nav-link rounded-pill bg-gradient active" id="tab--1" data-bs-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true" style="background-color: #DC6A2A;">Description</a></li>
